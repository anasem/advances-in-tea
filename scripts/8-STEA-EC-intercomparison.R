...
fluxes_data <- readRDS("data/rds/stea_ec_fluxes.rds")
good_quality_filter <- fluxes_data[, quality_flag == "OK"]
...
co2_diurnal_cycle_plot <- 
    ggplot(fluxes_data[good_quality_filter]) + 
        ...
        no_grid()
#
print(co2_diurnal_cycle_plot)

# Time series plot -------------------------------------------------------------
ts_start <- ymd_hms("2020-06-18 00:00:00")
ts_end   <- ymd_hms("2020-06-26 02:00:00")
ts_end - ts_start
#
...
flux_comparisons_combined <- 
     (co2_ts_plot + theme(plot.margin = margin(30,0,40,0))) / 
        ...
        plot_annotation(tag_levels = "a", tag_suffix = ")", 
            ...
            legend_below()
print(flux_comparisons_combined)
            
psave("STEA-EC-flux-intercomparison.pdf", p = flux_comparisons_combined,
